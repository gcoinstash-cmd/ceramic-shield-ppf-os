...
const ITEMS: ShowcaseItem[] = [
  {
    ...
    "features": [
      "ComputerCut Precision Plotter Patterns",
      "Self-Healing Elastomeric Polyurethane",
      "Hydrophobic Stain Resistance Coating",
      "Carfax Verified Digital Warranty Entry"
    ],
  ...
  },
  {
    ...
    "features": [
      "Rotary & DA Jewel Polish Finish",
      "Thermal IR Shortwave Baking (160°F)",
      "Super-Hydrophobic Contact Angle > 115°",
      "Free Annual Top Coat Maintenance"
    ],
  ...
  },
  {
    ...
    "features": [
      "Triple Thickness 10mil Rocker Protection",
      "Zero Seams Visible Installation",
      "Factory Headlight UV Guard Shield",
      "Track Day Damage Replacement Warranty"
    ],
    ...
    <div className="min-h-screen bg-[#0A0A0B] text-zinc-100 font-sans selection:bg-rose-500/20 selection:text-rose-400">
      ...
      <header className="sticky top-0 z-40 bg-[#0A0A0B]/90 backdrop-blur-md border-b border-zinc-800/80 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-xs font-mono uppercase tracking-widest text-rose-500 font-semibold">High-End Automotive PPF & Ceramic Coating Studio OS</span>
              <h1 className="text-lg font-bold tracking-tight text-white leading-none">CERAMIC SHIELD & PPF OS</h1>
            </div>
          </div>
      ...
      <section className="relative pt-20 pb-24 px-6 overflow-hidden border-b border-zinc-800">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-4xl sm:text-6xl font-extrabold text-white tracking-tight leading-tight">
            CERAMIC <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-red-500">SHIELD & PPF OS</span>
          </h2>

          <p className="mt-6 text-lg sm:text-xl text-zinc-400 max-w-3xl mx-auto leading-relaxed">
            Multi-Stage Paint Correction, Self-Healing Film & Warranty Vault. Precision craft, dedicated client portals, and turnkey Supabase PostgreSQL database schemas.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            >
              ...
              <span className="text-rose-400 font-mono text-xs font-bold">[ceramic2026]</span>
            </button>
          </div>
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto text-left">
              ...
              <div key="ACTIVE CURE BAYS" className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-sm">
                <span className="text-[10px] font-mono text-zinc-400 uppercase tracking-wider block">ACTIVE CURE BAYS</span>
                <p className="text-lg sm:text-xl font-bold font-mono text-rose-400 mt-1">{"6 BAYS"}</p>
              </div>
            
              <div key="10-YR WARRANTIES ISSUED" className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-sm">
                <span className="text-[10px] font-mono text-zinc-400 uppercase tracking-wider block">10-YR WARRANTIES ISSUED</span>
                <p className="text-lg sm:text-xl font-bold font-mono text-rose-400 mt-1">{"1,420 UNITS"}</p>
              </div>
            
              <div key="AVERAGE MICRON CORRECTION" className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-sm">
                <span className="text-[10px] font-mono text-zinc-400 uppercase tracking-wider block">AVERAGE MICRON CORRECTION</span>
                <p className="text-lg sm:text-xl font-bold font-mono text-rose-400 mt-1">{"3.2 µm"}</p>
              </div>
            
              <div key="IR CURE COMPLIANCE" className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-sm">
                <span className="text-[10px] font-mono text-zinc-400 uppercase tracking-wider block">IR CURE COMPLIANCE</span>
                <p className="text-lg sm:text-xl font-bold font-mono text-rose-400 mt-1">{"100% PASS"}</p>
              </div>
      ...
      <footer className="py-12 px-6 border-t border-zinc-800 bg-[#0A0A0B] text-zinc-500 text-xs font-mono">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <span className="text-zinc-300 font-bold">CERAMIC SHIELD & PPF OS</span> • Commercial Studio OS v1.0.0
          </div>
